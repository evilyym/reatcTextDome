...
export const buildingTypeSelect = () =>
	HttpClient.get("/admin/select/buildingTypeSelect");
...
export const departmentSelect = () =>
	HttpClient.get("/admin/select/departmentSelect");

// 绑定状态下拉
export const bindStatusSelect = () =>
	HttpClient.get("/admin/select/bindStatusSelect");
...
// 园区下拉
export const getCommunitySelect = () =>
	HttpClient.get("/admin/select/getCommunitySelect");
