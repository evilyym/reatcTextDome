...
export default function Home() {
  ...
  const down = () => {
    if (!gameOver && currentTetrominoValid) {
      setCurrentTetromino(moveDownTetromino(currentTetromino, tetrominoes, onCollise, () => setGameOver(true)));
    }
  };
  ...
  const fallDown = () => {
    if (!gameOver && currentTetrominoValid) {
      fallDownTetromino(currentTetromino, tetrominoes, onCollise, () => setGameOver(true));
    }
  };
