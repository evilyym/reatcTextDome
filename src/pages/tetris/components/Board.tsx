...
export default function Board() {
  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      <div
        className="outline outline-1 outline-black rounded relative"
        style={{ width: BOARD_WIDTH, height: BOARD_HEIGHT }}
      >
        {currentTetromino && <Tetromino {...currentTetromino} active={true} />}
        {predictedTetromino && <Tetromino {...predictedTetromino} active={true} dashed={true} />}
